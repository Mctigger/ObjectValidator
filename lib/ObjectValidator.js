...
function getValidateFunction(schema) {
    switch (schema.type) {
        case 'object':
            return _.partialRight(_.bind(this.validateObject, this), schema.ref);            
            break;
        case 'array':
            return _.partialRight(_.bind(this.validateArray, this), schema.ref);
            break;
        case 'scalar':
            return _.partialRight(_.bind(this.validateScalar, this), schema.constraints);
            break;
        default:
            throw new Error('A schema contains the invalid type "' + schema.type + '"');
    }
};
...
ObjectValidator.prototype.validateObject = function(object, schema) {
    ...
    _.each(object, function(value, key, list) {
        ...
        if(_.has(schema, key)) {
            result[key] = getValidateFunction.call(this, (schema[key]))(value);
            delete schema[key];
        }
...
ObjectValidator.prototype.validateArray = function(array, schema) {
    ...
    var validateElement = getValidateFunction.call(this, (schema));
